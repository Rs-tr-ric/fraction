...
fn sqrt_fraction_loop() {
    for _ in 0..50000 {
        sqrt_fraction(
            Fraction::new(
                black_box(rand::random_range(0..i32::MAX)), 
                black_box(rand::random_range(1..i32::MAX))
            )
        );
    }
}
...
fn sqrt_f64_loop() {
    for _ in 0..50000 {
        sqrt_f64(
            black_box(rand::random_range(0..i32::MAX)) as f64 / 
            black_box(rand::random_range(1..i32::MAX)) as f64
        );
    }
}
